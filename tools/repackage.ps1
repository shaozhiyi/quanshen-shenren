<#
    ...
    做的事：
      · 把 build/ 里旧的 游戏大乱斗.exe 送进回收站（不永久删除）
      · 把 build/out_game.exe 改名为 build/游戏大乱斗.exe
      · 同步一份到 web/files/game.exe，并把 build/玩法说明.txt 同步成 web/files/readme.txt
